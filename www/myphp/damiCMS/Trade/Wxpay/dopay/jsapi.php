...
echo '<font color="#f00"><b>统一下单支付单信息</b></font><br/>'.$body;
//printf_info($order);
	...
	function jsApiCall()
	{
		WeixinJSBridge.invoke(
			...
			function(res){
				   ...
				   <?php $gourl = (strpos($out_trade_no,'CZ')===false?'/':'/index.php?m=Member&a=chongzhi');?>
...
<body>
    <br/>
    <font color="#9ACD32"><b>该笔订单支付金额为<span style="color:#f00;font-size:50px"><?php echo floatval($_REQUEST['WIDtotal_fee']);?>元</span></b></font><br/><br/>
	<div align="center">
