...
<link href="__PUBLIC__/themes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="__PUBLIC__/themes/css/core.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="__PUBLIC__/themes/css/print.css" rel="stylesheet" type="text/css" media="print"/>
<link href="__PUBLIC__/uploadify/css/uploadify.css" rel="stylesheet" type="text/css" media="screen"/>
<!--[if IE]>
<link href="__PUBLIC__/themes/css/ieHack.css" rel="stylesheet" type="text/css" media="screen"/>
<![endif]-->

<!--[if lt IE 9]><script src="__PUBLIC__/js/speedup.js" type="text/javascript"></script><script src="__PUBLIC__/js/jquery-1.11.3.min.js" type="text/javascript"></script><![endif]-->
<!--[if gte IE 9]><!--><script src="__PUBLIC__/js/jquery-2.1.4.min.js" type="text/javascript"></script><!--<![endif]-->
...
<script src="__PUBLIC__/js/jquery.bgiframe.js" type="text/javascript"></script>
...
<script type="text/javascript" src="__PUBLIC__/chart/raphael.js"></script>
<script type="text/javascript" src="__PUBLIC__/chart/g.raphael.js"></script>
<script type="text/javascript" src="__PUBLIC__/chart/g.bar.js"></script>
<script type="text/javascript" src="__PUBLIC__/chart/g.line.js"></script>
<script type="text/javascript" src="__PUBLIC__/chart/g.pie.js"></script>
<script type="text/javascript" src="__PUBLIC__/chart/g.dot.js"></script>


<script src="__PUBLIC__/bin/dwz.min.js" type="text/javascript"></script>
<!-- 可以用dwz.min.js替换前面全部dwz.*.js (注意：替换时下面dwz.regional.zh.js还需要引入)
<script src="bin/dwz.min.js" type="text/javascript"></script>
-->
<script src="__PUBLIC__/js/dwz.regional.zh.js" type="text/javascript"></script>
				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							...
							<li><a>图表</a>
								<ul>
									<li><a href="__PUBLIC__/chart/test/barchart.html" target="navTab" rel="chart">柱状图(垂直)</a></li>
									<li><a href="__PUBLIC__/chart/test/hbarchart.html" target="navTab" rel="chart">柱状图(水平)</a></li>
									<li><a href="__PUBLIC__/chart/test/linechart.html" target="navTab" rel="chart">折线图</a></li>
									<li><a href="__PUBLIC__/chart/test/linechart2.html" target="navTab" rel="chart">曲线图</a></li>
									<li><a href="__PUBLIC__/chart/test/linechart3.html" target="navTab" rel="chart">曲线图(自定义X坐标)</a></li>
									<li><a href="__PUBLIC__/chart/test/piechart.html" target="navTab" rel="chart">饼图</a></li>
								</ul>
							</li>
...
如何精简JS：
	...
	2) demo index页面head中引入的几个第三方JS库也可以根据项目情况删除：
		__PUBLIC__/js/jquery.cookie.js			用于cookie中纪录jUI主题theme，下次打开浏览器时纪录用户选择的主题风格
		__PUBLIC__/js/jquery.validate.js		用于form表单验证
		__PUBLIC__/js/jquery.bgiframe.js		用于解决IE6 dialog盖不住navTab页面中的select问题
		__PUBLIC__/xheditor/xheditor-1.2.2.min.js	在线编辑器
		__PUBLIC__/xheditor/xheditor_lang/zh-cn.js	在线编辑器国际化
		__PUBLIC__/uploadify/scripts/jquery.uploadify.min.js	多文件上传
</pre>
