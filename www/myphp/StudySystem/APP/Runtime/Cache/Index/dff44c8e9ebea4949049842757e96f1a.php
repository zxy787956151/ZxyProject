...
<html lang="zh-CN">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="__PUBLIC__/css/reed.css">
    <script type="text/javascript" src="__PUBLIC__/JQ/jquery-2.1.4.js"></script>
    <script type="text/javascript" src="__PUBLIC__/Ajax/ajax.js"></script>
  ...
  <body>   
      ...
      <img src="__PUBLIC__/images/index.gif" class="headimg">          <!-- 页头大图 -->
	  	<div class="row">
      ...
      <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12 landing">
              <div id="btn" class="camera"><img src="__PUBLIC__/images/camera.png"></div>
