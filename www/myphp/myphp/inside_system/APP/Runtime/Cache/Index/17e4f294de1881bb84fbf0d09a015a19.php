...
<body>
	<form action='<?php echo U(GROUP_NAME . "/Index/Index/forget_deal");?>' method="post">
		...
		<table class="table">
			...
			<tr>
				...
				<td>
					<?php
 $user = M('user')->where(array('username' => $_GET['u']))->find(); echo $user['protect_question']."?"; session_start(); $_SESSION['que']=$user['protect_question']; ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input id="un" type="text" name="ans" />
				</td>
			</tr>
