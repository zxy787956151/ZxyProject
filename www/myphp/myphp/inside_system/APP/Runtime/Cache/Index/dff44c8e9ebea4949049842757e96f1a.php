...
<link href="__INDEX__/jw/base.css" rel="stylesheet" type="text/css">
<title>经纬实验室首页</title>
<script src="__INDEX__/jw/jquery-1.7.1.min.js" type="text/javascript"></script><script type="text/javascript">
//滚动插件
(function($){
$.fn.extend({
...
<script type="text/javascript">
    ...
    function jump() {
        window.location.href="http://my.php.com/inside_system/";
    }
    function register() {
        window.location.href="http://my.php.com/inside_system/index.php/Index/Login/Login";
    } 
	...
	<div class="banM">
        ...
        <div class="banright">
            <div class="ban">
                ...
                <div class="ban_tu">
                	<img src="__INDEX__/jw/class.jpg">
                </div>
            </div>
            <div class="ban2">
                ...
                <button class="btn_red">参加课程</button>
            </div>
            <div class="ban2">
            	<div class="bantitle2">温馨提示</div>
                <div class="ban_text3">没有学不到，只有做不到</div>
                <div class="ban_text3">经纬工作室欢迎您的加入</div>
...
<div class="loginbg">
	<div class="loginM">
        <?php  if ($_GET['pd']==1) { echo "<marquee>
                    ...
                    <input style='float:right' type='button' value='退出登录' 
                    onclick='jump()' />
                    "; } else{ echo "<div class='loginM'>
        <form action='index.php/Index/Login/index' method='post'>
            ...
            <img src='index.php/Index/Index/verify' id='code'/> 
            ...
            <span>
                <a href='index.php/Index/Index/forget'>忘记密码</a>
            </span>
        </form>
    </div>"; } ?>
        
<!-- <button class="btn" onClick="location.href='<?php echo U(GROUP_NAME . '/Login/index/');?>' ">登录</button> -->
...
<div class="center">
	<div class="center_M">
    	<div class="cen_lt">
            ...
            <div id="scrollDiv">
                <ul style="margin-top: -28.799900796287px;">
                <li>
                	<p>
                    	<strong>WHO癌症阶梯治疗策略新进展WHO</strong>
                        <span>
                        	<em>讲着：张海波</em>
                    ...
                    <p>
                    	<b>文字自动隐藏...</b>
                        <span><a href="http://demo.mycodes.net/moban/kongzhong_class/#">上海是东方医院上海海</a></span>
                    </p>
                </li><li>
                	<p>
                    	<strong>WHO癌症阶梯治疗策略新进展WHO</strong>
                	...
                	<p>
                    	<strong>WHO癌症阶梯治疗策略新进展WHOWHO癌症阶梯治疗策略新进展WHOWHO癌症阶梯治疗策略新进展WHOWHO癌症阶梯治疗策略新进展WHO</strong>
                        <span>
                        	<em>讲着：张海波</em>
                            <button class="btn_red_small">查看</button>
                        </span>
                    ...
                    <p>
                    	<b>文字自动隐藏文字自动隐藏文字自动隐藏文字自动隐藏文字自动隐藏文字自动隐藏文字自动隐藏文字自动隐藏文字自动隐藏文字自动隐藏...</b>
                        <span><a href="http://demo.mycodes.net/moban/kongzhong_class/#">上海是东方医院上海海1111</a></span>
                    </p>
                </li><li>
                	<p>
                    	<strong>WHO癌症阶梯治疗策略新进展WHO</strong>
        ...
        <div class="cen_rt">
        	<div class="cen_title_rt">历届负责人风采&nbsp;<span><a href="#" target="_blank">更多 &gt;&gt;</a></span></div>
