...
?>" width="150" height="110" alt="<?php echo $this->_var['daijin_item']['name']; ?>" class="lazy" auto_tag="1" auto_order="<?php echo $this->_var['daijin_item']['auto_order']; ?>" multi_attr="<?php echo $this->_var['daijin_item']['multi_attr']; ?>" is_today="<?php echo $this->_var['daijin_item']['is_today']; ?>" /></a>
