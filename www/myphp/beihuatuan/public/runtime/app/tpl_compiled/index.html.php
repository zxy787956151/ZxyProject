		...
		<div class="box_main clearfix">
			...
			<div class="index_filter" style="border-bottom:#f2f2f2 solid 1px;">
				...
				<div class="filter_item clearfix">
					<ul>
					<?php $_from = $this->_var['cate_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cate_item_0_94126900_1459957820');if (count($_from)):
    foreach ($_from AS $this->_var['cate_item_0_94126900_1459957820']):
?>
					<li><a href="<?php echo $this->_var['cate_item_0_94126900_1459957820']['url']; ?>" title="<?php echo $this->_var['cate_item_0_94126900_1459957820']['name']; ?>"><?php echo $this->_var['cate_item_0_94126900_1459957820']['name']; ?></a>&nbsp;<span>(<?php echo $this->_var['cate_item_0_94126900_1459957820']['count']; ?>)</span></li>
...
?>
	...
	<div class="blank"></div>
	<?php if ($this->_var['hot_group_count'] > 0): ?>
