...
?>" width=215 height=145  alt="<?php echo $this->_var['right_tuan_item']['name']; ?>" class="lazy" /></a>
				...
				<div class="index_tuan_price">
					<div class="f_l">团购价：<span style="color:#f30; font-size:14px; font-weight:bolder; font-family:verdana;"><?php echo $this->_var['right_tuan_item']['current_price_format']; ?></span></div>
					<div class="f_r">折扣：<span style="color:#f30;  font-size:14px; font-weight:bolder; font-family:verdana;"><?php echo $this->_var['right_tuan_item']['discount']; ?></span>折</div>
