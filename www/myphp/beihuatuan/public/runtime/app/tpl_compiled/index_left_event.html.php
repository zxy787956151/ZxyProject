...
?>
			<div class="index_event_item sector_3" style="<?php if ($this->_var['key'] % 3 == 2): ?>border-right:none; width:236px;<?php endif; ?> <?php if ($this->_var['key'] > ( count ( $this->_var['event_list'] ) - 1 - ( count ( $this->_var['event_list'] ) % 3 ) )): ?>border-bottom:none;<?php endif; ?>">
				<a href="<?php
...
?>" width=215 height=145 class="lazy" alt="<?php echo $this->_var['event_item']['name']; ?>" /></a>
				<div class="blank"></div>
				<a href="<?php
echo parse_url_tag("u:youhui|edetail|"."id=".$this->_var['event_item']['id']."".""); 
