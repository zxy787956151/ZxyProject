...
?>" width=450  class="lazy" alt="<?php echo $this->_var['deal']['name']; ?>" auto_tag="1" auto_order="<?php echo $this->_var['deal']['auto_order']; ?>" multi_attr="<?php echo $this->_var['deal']['multi_attr']; ?>" is_today="<?php echo $this->_var['deal']['is_today']; ?>" /></a>
								</li>
...
echo $k['name']($k['v'],$k['w'],$k['h'],$k['g']);
?>" width=287 height=179 class="lazy" alt="<?php echo $this->_var['deal']['name']; ?>" auto_tag="1" auto_order="<?php echo $this->_var['deal']['auto_order']; ?>" multi_attr="<?php echo $this->_var['deal']['multi_attr']; ?>" is_today="<?php echo $this->_var['deal']['is_today']; ?>"/></a>
				</div>
