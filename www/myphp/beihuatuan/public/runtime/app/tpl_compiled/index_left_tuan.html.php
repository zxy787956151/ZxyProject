...
?>
			<div class="index_tuan_item sector_3" style="<?php if ($this->_var['key'] % 3 == 2): ?>border-right:none; width:236px;<?php endif; ?> <?php if ($this->_var['key'] > ( count ( $this->_var['tuan_list'] ) - 1 - ( count ( $this->_var['tuan_list'] ) % 3 ) )): ?>border-bottom:none;<?php endif; ?>">
...
?>" width=215 height=145 class="lazy" alt="<?php echo $this->_var['tuan_item']['name']; ?>" auto_tag="1" auto_order="<?php echo $this->_var['tuan_item']['auto_order']; ?>" multi_attr="<?php echo $this->_var['tuan_item']['multi_attr']; ?>" is_today="<?php echo $this->_var['tuan_item']['is_today']; ?>" /></a>
...
?></a>
				...
				<div class="index_tuan_price">
					<div class="f_l">团购价：<span style="color:#f30; font-size:14px; font-weight:bolder; font-family:verdana;"><?php echo $this->_var['tuan_item']['current_price_format']; ?></span></div>
					<div class="f_r">折扣：<span style="color:#f30;  font-size:14px; font-weight:bolder; font-family:verdana;"><?php echo $this->_var['tuan_item']['discount']; ?></span>折</div>
				</div>
			</div>
			<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		</div><!--end box_main-->
