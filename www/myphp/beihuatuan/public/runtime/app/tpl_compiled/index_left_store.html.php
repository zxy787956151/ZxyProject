...
?>
			<div class="index_store_item sector_4"  style="<?php if ($this->_var['key'] % 4 == 3): ?>border-right:none; width:177px;<?php endif; ?> <?php if ($this->_var['key'] > ( count ( $this->_var['store_list'] ) - 1 - ( count ( $this->_var['store_list'] ) % 4 ) )): ?>border-bottom:none;<?php endif; ?>">
				<a href="<?php
