...
?></a>
					...
					<div class="youhui_downcount"><span style="color:#fe7000; font-weight:bolder; font-family:verdana;"><?php echo intval($this->_var['right_youhui_item']['sms_count'])+intval($this->_var['right_youhui_item']['print_count']);?></span>人已下载</div>		
				</div>
			</div>
