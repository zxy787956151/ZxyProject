							...
							<?php if ($this->_var['deal']['time_status'] == 1): ?> 
								...
								<?php if ($this->_var['deal']['buy_status'] == 1): ?> 
									...
									<p class="deal-buy-tip-notice">
										<?php if ($this->_var['deal']['is_lottery'] == 1): ?>
										<?php 
$k = array (
  'name' => 'sprintf',
...
?>" style="color:#f30;"><?php echo $this->_var['LANG']['INVITE_LOTTERY_DEAL_TIP']; ?></a>
							...
							<!--status-->
								...
								<a class="expire_refund_<?php echo $this->_var['deal']['expire_refund']; ?> rightline" href="javascript:void(0);">
								<div class="refund_ico"></div>															
								<div class="refund_title"><?php if ($this->_var['deal']['expire_refund'] == 1): ?>支持<?php else: ?>不支持<?php endif; ?>过期退</div>
								</a>
								<a class="any_refund_<?php echo $this->_var['deal']['any_refund']; ?>" href="javascript:void(0);">
								<div class="refund_ico"></div>		
								<div class="refund_title">	<?php if ($this->_var['deal']['any_refund'] == 1): ?>支持<?php else: ?>不支持<?php endif; ?>随时退</div>
								</a>								
								</div>				
						</div>
...
?>" auto_tag_deal="1" auto_order="<?php echo $this->_var['deal']['auto_order']; ?>" multi_attr="<?php echo $this->_var['deal']['multi_attr']; ?>" is_today="<?php echo $this->_var['deal']['is_today']; ?>">
								</li>
					...
					<div class="box box-split cf">		
						<div class="box-content cf">
							...
							<div class=" lazy box_main" rel="1">
									<?php echo $this->fetch('inc/promote_list.html'); ?>
