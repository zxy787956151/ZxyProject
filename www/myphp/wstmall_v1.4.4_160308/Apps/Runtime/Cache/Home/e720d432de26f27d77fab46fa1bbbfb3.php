                ...
                <div id="succeed" class="wst-ods-success">
                    <div class="success2" style="margin: 0 auto;">
                        ...
                        <div class="wst-ods-success-step">
                            <img src="/wstmall_v1.4.4_160308/Apps/Home/View/default/images/step3.png" alt="" /><br />
			...
			<div class="wst-ods-success-tb">
					<div class="wst-ods-success-tc">
						<div class="wst-ods-success-td">
							<?php if(count($orderInfos['list']) > 0): ?><img src="/wstmall_v1.4.4_160308/Apps/Home/View/default/images/icon-succ.png" alt="" /><?php endif; ?>
						</div>
						<div class="wst-ods-success-tf">
							<div class="wst-ods-success-l25">
								<?php if(count($orderInfos['list']) > 0): ?><span class="wst-ods-success-tg">订单提交成功！</span>					
								订单号：
								<?php if(is_array($orderInfos['list'])): $key = 0; $__LIST__ = $orderInfos['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($key % 2 );++$key; if(($key > 1) AND ($orderInfos['isMoreOrder'] == 1)): ?>、<?php endif; ?>
								 ...
								 应付金额：<span class="wst-ods-success-ti"><?php echo ($orderInfos['totalMoney']); ?></span> 元<?php endif; ?>
	   						</div>							
						</div>
						<div class="wst-clear"></div>
					</div>					
