...
<html lang="zh-cn">
	<head>
      	...
      	<title>品牌汇 - <?php echo ($CONF['mallTitle']); ?></title>
      	<meta name="keywords" content="<?php echo ($CONF['mallKeywords']); ?>" />
      	<meta name="description" content="<?php echo ($CONF['mallDesc']); ?>,商城品牌展示" />
      	<link rel="stylesheet" href="/wstmall_v1.4.4_160308/Apps/Home/View/default/css/common.css" />
     	<link rel="stylesheet" href="/wstmall_v1.4.4_160308/Apps/Home/View/default/css/brandslist.css" />
...
<div class="headNav">
		...
		<div>
			<div class="wst-brands-ads">
				<?php if(is_array($ads)): $i = 0; $__LIST__ = $ads;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i == 1): ?><a href="<?php echo U('Home/Index/access/',array('id'=>$vo['adId'],'url'=>$vo['adURL']));?>" target="_blank">
		...
		<div class="wst-shadow">
				<div class="wst-brands-area">
					&nbsp;&nbsp;&nbsp;&nbsp;请选择品牌所在区域
					<select id="areaId" onchange="changeAreaBrands();">
					...
					<div style="float:right;">
						<div class='wst-brands-search'>
							<input id="brandName" class='brands-ipt' placeholder="品牌名称" autocomplete="off">
							<div class='search' onclick="changeAreaBrands();">搜&nbsp;索</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="wst-container">
			<div >
                ...
                <a href="{{ Think.U('Home/goods/getGoodsList','brandId='+d[i].brandId) }}">
				    <li data="{{d[i].brandId}}" class="wst-brands" onmouseout="brandout(this)" onmouseover="brandsover(this)" style="opacity: 1;">
				        <div style="wst-brands-items">
                        <img width="188" class='lazyBrandImg' title="{{d[i].brandName}}" data-original="/wstmall_v1.4.4_160308/{{d[i].brandIco}}" src="" style="display: inline;">
                        </div>
				    </li>
				</a>
                {{# } }}
                </script>
				<div class="wst-brands-box" >
					<div class="wst-clear"></div>
				</div>
...
<!--右侧贴边导航quick_links.js控制-->
	...
	<script src="/wstmall_v1.4.4_160308/Apps/Home/View/default/js/brandslist.js"></script>
</html>