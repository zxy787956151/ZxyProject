...
<link rel="stylesheet" href="/wstmall_v1.4.4_160308/Apps/Home/View/default/css/index.css" />
...
<div class="headNav">
	...
	<div class="wst-ad">
		<div class="wst-slide" id="wst-slide">
			<ul class="wst-slide-items" style="min-width:1210px;">
				<?php if(is_array($indexAds)): $k = 0; $__LIST__ = $indexAds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li style="z-index: 1;"><a target="_blank" onclick="addAccess(<?php echo ($vo['adId']); ?>)" href="<?php echo ($vo['adURL']); ?>">
						<img src="/wstmall_v1.4.4_160308/<?php echo ($vo['adFile']); ?>" height="360" width="100%" title="<?php echo ($vo['adName']); ?>" />
				</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	</div>
			...
			<div class="wst-fl-left wst-fl<?php echo ($k1); ?>" style="position: relative;">
				<div
					...
					<?php if(is_array($catAds[$vo1['catId']])): $kv = 0; $__LIST__ = $catAds[$vo1['catId']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($kv % 2 );++$kv;?><a onclick="addAccess(<?php echo ($vo['adId']); ?>)" href="<?php echo ($vo['adURL']); ?>" target="_blank"> 
						<img class='lazyImg' data-original="/wstmall_v1.4.4_160308/<?php echo ($vo['adFile']); ?>" height="275" width="210" title="<?php echo ($vo['adName']); ?>" />
					</a><?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				<div
					style="position: absolute; top: 0px; left: 0px; width: 99%; height: 40px; padding-left: 10px; color: #ffffff; line-height: 38px; font-weight: bolder; background: url(/wstmall_v1.4.4_160308/Apps/Home/View/default/images/<?php echo ($k1); ?>fhd.png) no-repeat 100% 100%;">
					<a
						...
						<?php if(is_array($vo1['jpgoods'])): $k2 = 0; $__LIST__ = $vo1['jpgoods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k2 % 2 );++$k2;?><li class="wst-goodsbox">
							<div class="wst-goods-thumb">
								<a
									...
									<img class='lazyImg' data-original="/wstmall_v1.4.4_160308/<?php echo ($vo2['goodsThums']); ?>" width="180" />
								</a>
							</div>
						...
						<?php if(is_array($vo2['goods'])): $k3 = 0; $__LIST__ = $vo2['goods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($k3 % 2 );++$k3;?><li class="wst-goodsbox">
							<div class="wst-goods-thumb">
								<a
									...
									<img class='lazyImg' data-original="/wstmall_v1.4.4_160308/<?php echo ($vo3['goodsThums']); ?>" width="180" />
								</a>
							</div>
							<div class="wst-goods-thumb-des">
								<div class="goodsname">
								...
								<div>
									...
									<a href="javascript:addCart(<?php echo ($vo3['goodsId']); ?>,0,'<?php echo ($vo3['goodsThums']); ?>')" class="wst-right btnCart" > <img
										src="/wstmall_v1.4.4_160308/Apps/Home/View/default/images/btn_addcart.png"
										width="85" />
									</a>
									<div class='wst-clear'></div>
								</div>
						...
						<?php if(is_array($vo1['recommendShops'])): $k2 = 0; $__LIST__ = $vo1['recommendShops'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k2 % 2 );++$k2;?><div style="width: 180px; margin-top: 10px;">
							<div style="width: 180px;">
								<a
									...
									<img class='lazyImg' data-original="/wstmall_v1.4.4_160308/<?php echo ($vo2['shopImg']); ?>" height="120" width="180" />
								</a>
							</div>
						</div><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
...
<!--右侧贴边导航quick_links.js控制-->
    ...
    <script src="/wstmall_v1.4.4_160308/Apps/Home/View/default/js/global.js" type="text/javascript"></script>
    <script src="/wstmall_v1.4.4_160308/Apps/Home/View/default/js/head.js" type="text/javascript"></script>
    <script src="/wstmall_v1.4.4_160308/Apps/Home/View/default/js/goods.js" type="text/javascript"></script>
</body>
