...
<head>
        ...
        <title><?php echo ($CONF['mallTitle']); ?> - 在线支付</title>
	    ...
	    <link rel="stylesheet" href="/wstmall_v1.4.4_160308/Apps/Home/View/default/css/common.css" />
     	<link rel="stylesheet" href="/wstmall_v1.4.4_160308/Apps/Home/View/default/css/ordersuccess.css" />
                ...
                <div id="succeed" class="wst-ods-success">
                    <div class="success2" style="margin: 0 auto;">
                        ...
                        <div class="wst-ods-success-step">
                            <img src="/wstmall_v1.4.4_160308/Apps/Home/View/default/images/step1.png" alt="" /><br />
                            <span class="wst-pay-success-step1 wst-pay-curr-step">1.在线支付</span>
				...
				<form autocomplete="off" method="get">
					<div class="wst-ods-success-tc"  style="background-color: #F8F8F8;">
						<div class="wst-ods-success-td">
							<?php if(count($orderInfos) > 0): ?><img src="/wstmall_v1.4.4_160308/Apps/Home/View/default/images/icon-succ.png" alt="" /><?php endif; ?>
						</div>
						<div class="wst-ods-success-tf">
							<div class="wst-ods-success-l25">
								<input type="hidden" id="orderIds" name="orderIds" value="<?php echo ($orderIds); ?>"/>
								...
								<?php if(count($orders) > 0): ?><div class="wst-ods-success-tg">请你尽快支付，以便订单快速处理！</div>	
								...
								<div id="wst-orders-box" style="margin-left: 75px;display:none;">
								 ...
								 <div style="border:1px dotted #dddddd;padding:10px;">
								 	...
								 	<?php if(is_array($payments)): $i = 0; $__LIST__ = $payments;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$payment): $mod = ($i % 2 );++$i; if($payment['isOnline'] == 1): ?><div class="wst-payCode" data="<?php echo ($payment['payCode']); ?>"><img src="/wstmall_v1.4.4_160308/<?php echo ($payment['payIcon']); ?>" width="160" height="45"/></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                	<div class="wst-clear"></div>
								 	</div>
								 	<div class="wst-clear"></div>
								 </div>
								 <div style="height:50px;line-height:50px;margin-top: 15px;">
									<input type="button" onclick="getPayUrl();" style="width:120px;height:35px;font-size:16px;" value="前往支付"/>
								 </div>
	   							<?php else: ?>
					...
					<div class="wst-ods-success-tk">			
						<div id="checkout" class="wst-checkout" >							
							<a class="btn-submit" href="/wstmall_v1.4.4_160308/index.php">
