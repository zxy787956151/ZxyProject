        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           <tr>
             ...
             <span style='margin-left:100px;'>
               ...
               <?php elseif($object["orderStatus"] == -5): ?>店铺不同意拒收
               <?php elseif($object["orderStatus"] == -4): ?>店铺同意拒收
           ...
           <tr>
             ...
             <table width='700'>
                ...
                <tr>
                  ...
                  <?php else: ?>
                  	<?php if($object["deliverType"] == 1): ?>店铺配送<?php else: ?>商城配送<?php endif; endif; ?>                                                
                  </td>
                </tr>
                <tr>
           ...
           <tr>
              <td>
                ...
                <?php if(is_array($object['goodslist'])): $i = 0; $__LIST__ = $object['goodslist'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><tr>
                  <td width='50'><img src='/wstmall_v1.4.4_160308/<?php echo ($goods["goodsThums"]); ?>' style='margin:2px;' width='50' height='50'/></td>
