...
<body>
<div id="results_entry">
      <h1>成绩学分录入</h1>
      <form role="form" class="form1" action="<?php echo U(GROUP_NAME .'/Grade/Ginsert');?>" method="post">
        <span>请输入学生学号</span>
    ...
    <form class="re-form2" action="<?php echo U(GROUP_NAME .'/Grade/Ginsert');?>" method="post">
      ...
      <span>请输入学生学号</span>
        ...
        placeholder="请输入学号" name="num">
        <br/>
         <span style="color:red">同一学号只能录入一次</span>
      ...
      <input type="submit" class="btn btn-default" style="margin-top:10px;" value="录入分数" name="submitI"/>
    </form>
   </div>
</body>
</html>