...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		var settings = {
			...
			upload_success_handler : function(file, serverData) {
				...
				//K('.ke-status > div', itemDiv).hide();//关闭状态
			}
		};
	...
	appendFile : function(file) {
		...
		var img = K('<div style="width:80px;height:80px;"  class="ke-img" data-status="' + file.filestatus + '" alt="' + file.name + '" >' + file.name + '</div>');
		photoDiv.append(img);
...
KindEditor.plugin('multifile', function(K) {
	var self = this, name = 'multifile',
		...
		imageFileTypes = K.undef(self.imageFileTypes, '*.jpg;*.gif;*.png;*.doc;*.docx;*.xls;*.xlsx;*.ppt;*.htm;*.html;*.txt;*.zip;*.rar;*.gz;*.bz2;*.gif;*.jpg;*.jpeg;*.png;*.bmp;*.swf;*.flv;*.mp3;*.wav;*.wma;*.wmv;*.mid;*.avi;*.mpg;*.asf;*.rm;*.rmvb'),
	...
	self.plugin.multiFileDialog = function(options) {
		...
		var swfupload = K.swfupload({
			...
			fileTypes : '*.jpg;*.gif;*.png;*.doc;*.docx;*.xls;*.xlsx;*.ppt;*.htm;*.html;*.txt;*.zip;*.rar;*.gz;*.bz2;*.gif;*.jpg;*.jpeg;*.png;*.bmp;*.swf;*.flv;*.mp3;*.wav;*.wma;*.wmv;*.mid;*.avi;*.mpg;*.asf;*.rm;*.rmvb',
			fileTypesDesc : 'Allow Files',
		...
		self.plugin.multiFileDialog({
			clickFn : function (urlList) {
				...
				K.each(urlList, function(i, data) {
					...
					self.exec('insertfile', data.url, data.title, data.width, data.height, data.border, data.align);
				});
