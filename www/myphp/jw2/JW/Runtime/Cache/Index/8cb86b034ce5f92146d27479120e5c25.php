...
<link href="/jw/PUBLIC/Css/base.css" rel="stylesheet" type="text/css">
<title>经纬实验室首页</title>
<script src="/jw/PUBLIC/Js/jquery-1.7.1.min.js" type="text/javascript">
</script>
<script src="/jw/PUBLIC/Js/login.js" type="text/javascript"></script>
	...
	<div class="banM">
        ...
        <div class="banright">
            <div class="ban">
                ...
                <div class="ban_tu">
                	<img src="/jw/public/Images/class.jpg">
                </div>
            </div>
            <div class="ban2">
...
<div class="loginbg">
	<div class="loginM">
        ...
        密码：<input type="text" value="" class="password" name="password">
        验证码：<input type="code" name="code" style="width:80px;height:25px"/><img src="<?php echo U(GROUP_NAME.'/Index/verify');?>" id="code"/><a href="javascript:void(change_code(this));">看不清</a>
        <a href="#">&nbsp;&nbsp;&nbsp;忘记密码</a>
