...
if(id == $(this).attr("data-id")){alert('购物车中已有该物品，请删除才能再加入购物车');is_add=false;};
});
var name=$('#gname').val();
var qty= $('#gnum').val();
...
if(is_add){
											$body.prepend('<div class="J-shoping-list" data-id="'+id+'"><a href="#"title=""><img src="' + pic + '" width="50"height="50"/></a><div class="J-shoping-list-a"><p>'+ name + '【' + qty + '件】</p><p><span class="shop_left">' + gtype + '</span><span class="shop_right"><em>' + price + '</em>元</span></p></div><div class="baseBg J-shoping-close"></div></div>');										
										    $num.text(num+1);
}
									});
								});
