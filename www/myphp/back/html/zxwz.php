	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="#" class="active"><span>最新文章</span></a></li>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<?php
								...
								if (@$_GET['page']=="") {
									$query="select * from zxwz limit 0,6;"; //定义sql
								}
								if (@$_GET['page']=='2') {
									$query="select * from zxwz limit 6,5;"; //定义sql
								}
								if (@$_GET['page']=='3') {
									$query="select * from zxwz limit 11,5;"; //定义sql
								}
						...
						<div class="pagging">
							...
							<div class="right">
								<a href="#">Previous</a>
								<a href="zxwz.php">1</a>
								<a href="zxwz.php?page=2">2</a>
								<a href="zxwz.php?page=3">3</a>
								<a href="zxwz.php?page=4">4</a>
								<a href="#">245</a>
								<span>...</span>
								<a href="#">Next</a>
								<a href="#">View all</a>
	...
	if (@$_POST['sub']=='submit') {
		if (@$_POST['title']=="") {
			...
			$pdo = new PDO("mysql:host=localhost;dbname=bk","root","");
				$pdo  -> exec("insert into zxwz(title,content)values('$title','$content');");
